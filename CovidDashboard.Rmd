...
combined_plot = combined_plot +
  labs(title="King County Covid-19 Cases",
       ...
       subtitle = "Daily cases and 14 day rolling average")
  ...
  layout(
    xaxis = list(
      ...
      title = list(text = paste0('King County Covid-19 Cases',
                                '<br>',
                                '<sup>',
                                 'Daily cases and 14 day rolling average. Data sourced from NY Times.','</sup>')
                   )
  )
```
...
fig <- plot_ly(
  ...
  value = value,
  title = list(text = "Cases per<br>100k Population"),
  type = "indicator",
