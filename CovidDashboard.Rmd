...
```{r County New Case History, echo=FALSE,warning=FALSE, message = FALSE, fig.width=10, fig.height=6, fig.align = "center"}
library(hrbrthemes)
...
### KPI
```{r state KPI,out.width=2,out.height=2,fig.align="right"}
